...
try
{
  $loader->validate(Yaml::parseFile(__DIR__.'/fixtures/yaml/nonvalid1.yml'));
...
try
{
  $loader->validate(Yaml::parseFile(__DIR__.'/fixtures/yaml/nonvalid2.yml'));
...
list($services, $parameters) = $loader->doLoad(Yaml::parseFile(__DIR__.'/fixtures/yaml/services2.yml'));
...
list($services, $parameters) = $loader->doLoad(Yaml::parseFile(__DIR__.'/fixtures/yaml/services3.yml'));
