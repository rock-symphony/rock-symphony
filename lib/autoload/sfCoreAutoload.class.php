 ...
 */
define('SYMFONY_VERSION', '1.7.0-dev');
...
class sfCoreAutoload
{
  ...
  protected $classes = array(
    ...
    'sfservicecontainerloader' => 'service/config/sfServiceContainerLoader.class.php',
    'sfservicecontainerloaderarray' => 'service/config/sfServiceContainerLoaderArray.class.php',
    'sfservicecontainerloaderinterface' => 'service/config/sfServiceContainerLoaderInterface.class.php',
    'sfservicedefinition' => 'service/config/sfServiceDefinition.class.php',
    'sfserviceparameter' => 'service/config/sfServiceParameter.class.php',
    'sfservicereference' => 'service/config/sfServiceReference.class.php',
